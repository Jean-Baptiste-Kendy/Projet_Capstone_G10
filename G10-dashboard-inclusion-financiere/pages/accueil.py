...
RESULTATS = [
    ...
    (
        ...
        "La segmentation K-Means distingue des territoires en zones d'exclusion financière, zones d'inclusion financière émergente, pôle d'inclusion financière avancée. Elle transforme une carte de disparités en une grille de priorisation opérationnelle.",
    ),
    (
...
PRIORITES = [
    (
        ...
        "Communes à exclusion financière : concentrer l'extension des points de service, l'interopérabilité de la finance mobile, l'information financière et l'accompagnement des usagers.",
    ),
    (
        "Priorité 2 — Convertir le potentiel",
        "Communes à inclusion financière émergente : transformer l'accès existant en usage actif, notamment par l'épargne, le paiement numérique et des produits adaptés aux ménages et aux petites activités.",
    ),
    (
        "Priorité 3 — Consolider et diffuser",
        "Communes à inclusion financière avancée : consolider les acquis, tester des innovations et identifier les pratiques reproductibles dans les territoires moins inclus.",
    ),
]
        ...
        children=[
            ...
            build_kpi_row([
                ...
                },
                {
                    ...
                    "sublabel": "retenu par validation multicritère",
                    "accent": True,
                },
                {
